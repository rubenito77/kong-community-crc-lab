...
| P03-04 | `acl` + autenticación | Consumer dentro del grupo | Consumer fuera del grupo | **Aprobada y revertida 2026-08-28:** HTTP 200 para grupo permitido, HTTP 403 fuera del grupo y HTTP 401 sin key o con key inválida; credenciales ocultadas y rutas de control aisladas. [Evidencia](plugin-test-results/acl-2026-08-28.md). |
| P03-05 | `hmac-auth` | Firma HMAC válida | Firma alterada o timestamp inválido | **Aprobada y revertida 2026-08-28:** HTTP 200 con firma HMAC-SHA256 válida; HTTP 401 sin firma, con firma inválida o fecha vencida; credencial oculta, rutas de control aisladas y rollback completo. [Evidencia](plugin-test-results/hmac-auth-2026-08-28.md). |
...
| P04-02 | `http-log` | Enviar logs a un receptor HTTP temporal | **Aprobada 2026-09-02; rollback pendiente:** cinco eventos correlacionados, GET/200, Route/Service y latencias validados; controles aislados durante 45 segundos. [Evidencia](plugin-test-results/http-log-2026-09-02.md). |
