...
| P03-05 | `hmac-auth` | Firma HMAC válida | Firma alterada o timestamp inválido | **Aprobada 2026-08-28; rollback pendiente:** HTTP 200 con firma HMAC-SHA256 válida; HTTP 401 sin firma, con firma inválida o fecha vencida; credencial oculta y rutas de control aisladas. [Evidencia](plugin-test-results/hmac-auth-2026-08-28.md). |
