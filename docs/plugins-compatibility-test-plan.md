...
| P04-02 | `http-log` | Enviar logs a un receptor HTTP temporal | **Preparado:** cinco eventos correlacionados; controles aislados. Ejecución pendiente. [Guía](plugin-tests/http-log.md). |
