...
| P04-03 | `opentelemetry` | Enviar spans a un collector OTLP | **Aprobada; rollback pendiente (2026-09-03):** cinco trazas W3C, spans raíz/balancer con duraciones positivas y controles aislados durante 45 s. [Evidencia](plugin-test-results/opentelemetry-2026-09-03.md). |
