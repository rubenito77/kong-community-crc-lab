...
| P03-04 | `acl` + autenticación | Consumer dentro del grupo | Consumer fuera del grupo | **Aprobada 2026-08-28; rollback pendiente:** HTTP 200 para grupo permitido, HTTP 403 fuera del grupo y HTTP 401 sin key o con key inválida; credenciales ocultadas y rutas de control aisladas. [Evidencia](plugin-test-results/acl-2026-08-28.md). |
